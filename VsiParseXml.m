...
function [ReturnParam] = VsiParseXml(filename, ModeName)
...
switch ModeName
    case '.bmode'
        ...
        for k = 0:AllParameters.getLength-1
            ...
            switch char(node.getAttribute('name'))
                ...
                case 'B-Mode/Centre'
                    javaWidth = node.getAttribute('value');
                    BmodeCentre = str2num(char(javaWidth));
                ...
                case '3D-Scan-Distance'
                    java3DScanDistance = node.getAttribute('value');
                    Bmode3DScanDistance = str2num(char(java3DScanDistance));
                case '3D-Step-Size'
                    java3DStepSize = node.getAttribute('value');
                    Bmode3DStepSize = str2num(char(java3DStepSize));
            end
        end
        ReturnParam = struct('BmodeNumSamples', BmodeNumSamples, 'BmodeNumLines', BmodeNumLines, ...
            'BmodeDepthOffset', BmodeDepthOffset, 'BmodeDepth', BmodeDepth, ...
            'BmodeWidth', BmodeWidth, 'BmodeCentre', BmodeCentre, 'BmodeRxFrequency', BmodeRxFrequency, ...
            'BmodeTxFrequency', BmodeTxFrequency, 'BmodeQuad2x', BmodeQuad2x, ...
            'BmodeNumFocalZones', BmodeNumFocalZones, 'Bmode3DScanDistance', Bmode3DScanDistance, ...
            'Bmode3DStepSize', Bmode3DStepSize);
        
    case '.3d.bmode'
        RxFreqModeName = '3D B-Mode';
        for k = 0:AllParameters.getLength-1
            node = AllParameters.item(k);
            switch char(node.getAttribute('name'))
                case 'B-Mode/Samples'
        ...
        ReturnParam = struct('BmodeNumSamples', BmodeNumSamples, 'BmodeNumLines', BmodeNumLines, ...
            'BmodeDepthOffset', BmodeDepthOffset, 'BmodeDepth', BmodeDepth,'BmodeWidth', BmodeWidth, ...
            'BmodeRxFrequency', BmodeRxFrequency, 'BmodeTxFrequency', BmodeTxFrequency, ...
            'BmodeQuad2x', BmodeQuad2x, 'BmodeNumFocalZones', BmodeNumFocalZones, ...
            'Bmode3DScanDistance', Bmode3DScanDistance, 'Bmode3DStepSize', Bmode3DStepSize);
    ...
    case '.color'
        ...
        ReturnParam = struct('ColorNumSamples', ColorNumSamples, 'ColorNumLines', ColorNumLines, ...
            'ColorDepthOffset', ColorDepthOffset, 'ColorRxFrequency', ColorRxFrequency, ...
            'ColorNumEnsemble', ColorNumEnsemble, 'ColorTxFrequency', ColorTxFrequency, ...
            'ColorEnsembleExtra', ColorEnsembleExtra, 'ColorLinesExtra',ColorLinesExtra, ...
            'ColorSteeringAngle',ColorSteeringAngle, 'BmodeNumSamples', BmodeNumSamples, ...
            'BmodeNumLines', BmodeNumLines,'BmodeDepthOffset', BmodeDepthOffset,...
    ...
    case '.pw'
        ...
        ReturnParam = struct('PwNsamples', PwNsamples, 'PwRxFrequency', PwRxFrequency, ...
            'PwTxPrf',PwTxPrf, 'PwSpectralSize',PwSpectralSize, 'PwSpectralSpacing', PwSpectralSpacing, ...
            'PwDisplayGain', PwDisplayGain, 'PwDisplayRange', PwDisplayRange, ...
            'PwYOffset', PwYOffset, 'PwVOffset', PwVOffset);
    ...
    case '.pamode'
        for k = 0:AllParameters.getLength-1
            ...
            switch char(node.getAttribute('name'))
                ...
                case 'Pa-Mode/Centre'
                    javaWidth = node.getAttribute('value');
                    PaCentre = str2num(char(javaWidth));
                case 'B-Mode/Samples'
                    javaNsamples = node.getAttribute('value');
                    BmodeNumSamples = str2num(char(javaNsamples));
                case 'B-Mode/Lines'
        ...
        ReturnParam = struct('PaNumSamples', PaNumSamples, 'PaNumLines', PaNumLines, ...
            'PaDepthOffset', PaDepthOffset, 'PaDepth', PaDepth, 'PaWidth', PaWidth, ...
            'PaCentre', PaCentre, 'BmodeNumSamples', BmodeNumSamples, 'BmodeNumLines', BmodeNumLines, ...
            'BmodeDepthOffset', BmodeDepthOffset, 'BmodeDepth', BmodeDepth, ...
            'BmodeWidth', BmodeWidth, 'BmodeRxFrequency', BmodeRxFrequency);
